...
export class ListeFormationComponent implements OnInit {
  ...
  constructor(private http: HttpClient, private sharedDataService: SharedDataService,
    ...
    private formationDetailServiceService: FormationDetailServiceService) {}
  ...
  ngOnInit() {
    ...
    // Subscribe to the new max value observables
  ...
  loadFormations() {
    ...
    // Append selected categories and range values to the URL if there are any
